                    ...
                    <div class="card-body">
                        <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th class="serial">#</th>
                                    <th class="from_image">From Image</th>
                                    <th class="id">ID</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="avatar">
                                        <div class="round-img">
                                            <a href="#"><img class=" " style="width: 75px;
                                                " src="{{ $user->from_image }}"
                                                    alt=""></a>
                                        </div>
                                    </td>
                                    <td> {{ $user->id }} </td>
                                    <td> <span class="from_address">{{ $user->from_address }}</span> </td>
                                    <td> <span class="from_latitude">{{ $user->from_latitude }}</span> </td>
                                    <td><span class="from_longitude">{{ $user->from_longitude }}</span></td>
                                    <td><span class="start_date">{{ $user->start_date }}</span></td>
                                    <td><span class="causes">{{ $user->causes }}</span></td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm"><i class="fa fa-rss"></i>&nbsp;Delete</button>
                                    </td>
                                </tr>
                                 @endforeach
